...
<head>
  ...
  <title>DevPro Admin | Log in</title>
...
<div class="login-box">
  <div class="login-logo">
    <img src="img/logo2.png" alt="" style="width:200px;">
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    ...
    <form action="post-login.php" method="post">
      ...
      <div class="row">
        ...
        <div class="col-xs-12">
          <button type="submit" class="btn btn-primary btn-block btn-flat" style="background: red;">Sign In</button>
        </div>
      </div>
    </form>
    <!-- /.social-auth-links -->
