...
<head>
    ...
    <title>DevPro đào tạo lập trình số 1 tại Hà Nội</title>
    ...
    <link rel="shortcut icon" type="image/png" href="img/_logo0.png">
            ...
            <nav class="navbar navbar-expand-sm shadow-sm bg-white sticky-top">
                ...
                <div class="collapse navbar-collapse" id="collapsibleNavId">
                    ...
                    <form class="form-inline my-2 mr-4 my-lg-0" method="post" action="timkiem.php">
                        ...
                        <button class="btn btn-dark my-2 my-sm-0" type="submit" style="background-color: red;">Search</button>
                    </form>
                </div>
            </nav>