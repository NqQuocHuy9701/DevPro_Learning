...
<div class="container-fluid py-4 bg-white">
    <div class="container py-4">
        <h2 class="text-center">CHÀO MỪNG BẠN ĐẾN VỚI DEVPRO </h2>
        <div class="row py-4">
            <div class="col-md-6">
                <img style="width: 500px;" src="<?php echo SITE_URL . $page['image']; ?>" alt="">
            </div>
            <div class="col-md-6 pt-2">
                <p><?php echo $page['tomtat']; ?></p>
                <a name="" id="" style="background-color: red;" class="btn btn-primary" href="introduct.php" role="button">Xem thêm</a>
            </div>
        </div>
    </div>
</div>
...
<div class="container-fluid py-4" style="background: #f7f7f7;">
    <div class="container py-4">
        <h2 class="text-center">GIẢNG VIÊN DEVPRO </h2>
        <div class="row py-4">
            <div class="owl-carousel owl-theme">
                <?php foreach ($teas as $row) { ?>
                    <div class="item shadow-sm">
                        <div class="card border-none" style="box-shadow: rgba(0, 0, 0, 0.4) 0px 2px 4px, rgba(0, 0, 0, 0.3) 0px 7px 13px -3px, rgba(0, 0, 0, 0.2) 0px -3px 0px inset; border-radius: 15px 15px 10px 10px" >
                            <img style="border-radius: 15px 15px 0 0" src="<?= SITE_URL . $row['avatar']  ?>" alt="img giảng viên">
                            <div class="card-body">
...
<div class="container-fluid py-4 bg-white">
    <div class="container py-4">
        <h2 class="text-center">KHÓA HỌC DEVPRO MỚI</h2>
        <div class="row my-4" style="width: 100%; display:flex; flex-wrap:inherit">
            <?php foreach ($cates1 as $row) { ?>
                <div class="card border-none col-md-3 rounded" style="padding: 10px; margin: 5px; box-shadow: rgba(0, 0, 0, 0.4) 0px 2px 4px, rgba(0, 0, 0, 0.3) 0px 7px 13px -3px, rgba(0, 0, 0, 0.2) 0px -3px 0px inset; border-radius: 15px 15px 10px 10px">
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-7">
                ...
                <p><i>Hãy để lại thông tin của bạn, DevPro sẽ giúp xây dựng lộ trình học IT tốt nhất dành riêng cho bạn.</i></p>
                <?php
                echo $page['video'];
                ?>
                <div class="embed-responsive embed-responsive-16by9">
                    <!-- <img src="/img/pro2.jpg" alt="" style="width: 500px"> -->
                    <iframe width="560" height="315" src="https://www.youtube.com/watch?v=n-etlfVH8NE" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                </div>
            </div>
            <div class="col-md-5">
                <div class="card shadow-sm rounded">
                    ...
                    <div class="card-body">
                        ...
                        <form method="post" action="dangky.php">
                            ...
                            <button type="submit" style="background-color: red;" class="btn btn-primary">Submit</button>
                        </form>
                    </div>
                </div>
            </div>
