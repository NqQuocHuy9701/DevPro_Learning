                    ...
                    <tr>
                      ...
                      <?php if ($_SESSION['login']['role'] == 500) { ?>
                        <th style="width: 110px">
                          <a href="<?= $ADMIN_URL ?>lop/add.php" class="btn btn-xs btn-success">
                      ...
                      <tr>
                        ...
                        <?php if ($_SESSION['login']['role'] == 500) { ?>
                          <td>
                            ...
                            <a href="javascript:;" linkurl="<?= $ADMIN_URL ?>lop/remove.php?id=<?= $row['id'] ?>" class="btn btn-xs btn-danger btn-remove">
